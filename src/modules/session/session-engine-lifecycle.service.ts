...
export class SessionEngineLifecycle {
  ...
  /** Delegate: SessionLifecycleFences.destroyEngineSafely. */
  private destroyEngineSafely(sessionId: string, engine: IWhatsAppEngine): Promise<boolean> {
    return this.fences.destroyEngineSafely(sessionId, engine);
  }
  ...
  /** Delegate: SessionLifecycleFences.awaitInitialStatus. */
  private awaitInitialStatus(id: string, engine: IWhatsAppEngine): Promise<void> {
    return this.fences.awaitInitialStatus(id, engine);
  }
