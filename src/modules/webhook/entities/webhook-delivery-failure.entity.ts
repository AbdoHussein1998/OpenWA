 ...
 *
 * webhookId/sessionId are historical provenance, not ownership FKs. This row has its own retention
 * policy and remains useful after the Webhook configuration or Session is removed.
 *
