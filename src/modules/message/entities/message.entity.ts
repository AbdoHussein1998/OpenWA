...
export class Message {
  ...
  // Historical Session provenance, deliberately NOT a TypeORM relation/FK. Message history must
  // survive physical Session deletion, so this scalar UUID remains available for paging, dedup,
  // search, archive authorization, and restore/rebind flows after the live Session row is gone.
