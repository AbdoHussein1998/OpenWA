...
@Module({
  imports: [
    ...
    /**
     * TeamLeaderModule exports AgentTemplateQuotaService.
     *
     * MessageController uses it only for the authenticated stored-template
     * endpoint. Normal text/media sends remain outside the Agent quota.
     */
    TeamLeaderModule,
  ],
