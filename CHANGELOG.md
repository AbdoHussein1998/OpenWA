...
- The Helm chart's new startup probe stops the kubelet killing a pod that is still booting, allowing 300s (`periodSeconds: 5`, `failureThreshold: 60`) where the liveness settings allowed 50.
