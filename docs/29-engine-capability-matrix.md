...
6 install-time patches (29.3). If it exists upstream or in OpenWA, it has a row here.
...
- **6** install-time patches (4 whatsapp-web.js + 2 Baileys), all exact and self-disabling.
